    ...
    public function executar($con) {
        ...
        foreach ($empresas as $key => $empresa) {
            ...
            if($empresa->id === 1734){
                ...
                $empresa->email->enviarEmail(new Email("detona@logc.com.br"), "RELATORIO DETONA RTC $empresa->nome", $html);
                $empresa->email->enviarEmail(new Email("detona@agrofauna.com.br"), "RELATORIO DETONA RTC $empresa->nome", $html);
