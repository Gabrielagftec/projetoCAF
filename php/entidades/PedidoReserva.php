...
class PedidoReserva {
    ...
    public function gerarCobranca() {
        ...
        try {
            $this->empresa->email->enviarEmail($this->empresa->email->filtro(Email::$FINANCEIRO), "Cobranca de pagamento1", $log->toHtml());
            $this->empresa->email->enviarEmail($this->cliente->email->filtro(Email::$FINANCEIRO), "Cobranca de pagamento1", $log->toHtml());
