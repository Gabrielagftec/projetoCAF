...
class ClienteRelatorio {
    ...
    public function getHistorico($con){
        ...
        $ps = $con->getConexao()->prepare("SELECT id,historico FROM historico_cliente WHERE id_cliente=$this->id_real");
        $ps->execute();
    ...
    public static function getClasses(){
        ...
        return array(
          ...
          array(15,"Recebeu boas vindas","Green"),
          array(16,"Recebeu email","Green"),
          array(17,"Nao Recebeu email","Red")
        );
    ...
    public function merge($con,$usuario) {
        ...
        if($this->classe === 15){
            ...
            $cliente = $this->getCliente($con);
            
            
            $cliente->enviarHtmlBoasVindas($con);
